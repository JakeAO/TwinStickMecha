...
namespace k
{
	public static class Scenes
	{
		...
		public const int SCENE_GARAGE_IDX = 3;
		public const int SCENE_SHOP_IDX = 4;
		public const int SCENE_PRE_GAME_IDX = 5;
		public const int SCENE_IN_GAME_IDX = 6;
		public const int SCENE_POST_GAME_IDX = 7;
	}
}