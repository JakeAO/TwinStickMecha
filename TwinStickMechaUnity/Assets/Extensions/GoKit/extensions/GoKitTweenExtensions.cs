...
public static class GoKitTweenExtensions
{
    ...
    public static GoTween anchoredPositionTo(this RectTransform self, float duration, Vector2 endValue, bool isRelative = false)
    {
        return Go.to(self, duration, new GoTweenConfig().anchoredPosition(endValue, isRelative));
    }

    public static GoTween anchoredPositionTo(this RectTransform self, float duration, Vector3 endValue, bool isRelative = false)
    {
        return Go.to(self, duration, new GoTweenConfig().anchoredPosition3D(endValue, isRelative));
    }
